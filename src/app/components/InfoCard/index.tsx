    ...
    >
      ...
      <Stack>
        ...
        <Text fontSize="16px" fontWeight={500} lineHeight="20px">
          Ahorrá con los mejores beneficios
        </Text>
        <Text color="blackAlpha.500" fontSize="16px" lineHeight="20px">
          Suscribite al nivel 6 desde $ 599/mes y ahorrá en envíos, suscripciones de contenido,
          pagos, ¡y mucho más!
        </Text>
      </Stack>

      <Tooltip hasArrow bg="red.500" closeOnClick={false} label="También es de mentira">
        <Button
          color="secondary.400"
          fontSize="14px"
          label="Es de mentira"
